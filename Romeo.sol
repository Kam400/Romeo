...
contract RomeoDoge is IERC20 {
    ...
    string constant _name = "Romeo Doge";
    string constant _symbol = "ROMEODOGE";
    ...
    uint256 public _buyFlirtFee = 300;
    uint256 public _buyKissFee = 500;

    uint256 public _sellLoveFee = 1100;
    uint256 public _sellFlirtFee = 400;
    uint256 public _sellKissFee = 600;
